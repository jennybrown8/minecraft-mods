...
public class NamedLocation implements Comparable<NamedLocation> {
	...
	if (this.playerUsername != null
		&& !this.playerUsername.equals(player.getCommandSenderEntity().getName()))
	    return false;
	...
	nl.setBlockPos(new BlockPos(Integer.parseInt(pieces[0]), Integer.parseInt(pieces[1]), Integer
		.parseInt(pieces[2])));
